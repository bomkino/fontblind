...
- Blind’s public response deliberately does not expose the internal `variable` flag. The packaged corpus gate therefore confirms the downloaded native font’s actual `fvar` table instead of inventing a new browser-visible model field.
